...
@:keep @:bind #if display private #end class __ASSET__assets_images_linkedit_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_linkedit2_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_linkedit2_png_ extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_images_something_jpg extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }

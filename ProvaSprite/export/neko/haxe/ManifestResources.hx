...
@:keep @:bind #if display private #end class __ASSET__assets_images_oshawuot_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_sunset_bottle_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }

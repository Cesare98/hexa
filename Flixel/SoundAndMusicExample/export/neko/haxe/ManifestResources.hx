...
@:keep @:bind #if display private #end class __ASSET__assets_music_joker_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_music_lancer_ogg extends null { }
